...
export default function Navbar() {
  return (
    <nav className="w-full pt-8 pb-4 px-4 flex flex-wrap justify-center items-center gap-4 font-medium text-gray-600">
      <Link href="/" className="px-4 py-2 rounded-full transition-all duration-200 hover:bg-[#bb8cca] hover:text-[#380645]">HOME</Link>
